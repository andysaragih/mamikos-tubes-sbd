            ...
            <form action="" method="post">
                <div class="card">
                    <div class="card-header">
                        <h1 class="title" style="margin: 0;">Foto Kamar</h1>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <h1 class="title">Tambahkan juga foto kamar</h1>
                                <p>Foto yang menarik adalah hal pertama yang diperhatikan oleh calon penyewa.</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <h2 class="title-2">Foto depan kamar</h1>
                        ...
                        <div class="row">
                            <div class="col">
                                <h2 class="title-2">Foto dalam kamar</h1>
                        ...
                        <div class="row">
                            <div class="col">
                                <h2 class="title-2">Foto kamar mandi</h1>
                        ...
                        <div class="row">
                            <div class="col">
                                <h2 class="title-2">Tambahan foto lain? boleh dong</h1>
                        ...
                        <div class="row mt-3" style="background-color: white;">
                            <div class="col-md-3">
                                <a class="btn btn-success" href="tambahkos-fotokos.php">Kembali</a>
                            </div>
                            <div class="col">
                                <a class="btn btn-primary" href="tambahkos-sediakamar.php">Lanjutkan</a>
                            </div>
                        </div>
                    </div>
                </div>
