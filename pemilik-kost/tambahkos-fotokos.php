            ...
            <form action="" method="post">
                <div class="card">
                    <div class="card-header">
                        <h1 class="title" style="margin: 0;">Foto Kos</h1>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <h1 class="title">Pasang foto terbaik kos Anda</h1>
                                <p>Foto yang menarik adalah hal pertama yang diperhatikan oleh calon penyewa.</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <h2 class="title-2">Foto bangunan tampak depan</h1>
                                    <p>Foto horizontal akan terlihat lebih bagus sebagai foto utama kos Anda.</p>
                                    <div class="mb-3">
                                        <input type="file" class="input-image" accept="image/*" class="form-control w-50"><br>
                                    </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <h2 class="title-2">Foto tampilan dalam bangunan</h1>
                        ...
                        <div class="row">
                            <div class="col">
                                <h2 class="title-2">Foto tampak dari jalan</h1>
                        ...
                        <div class="row mt-3" style="background-color: white;">
                            <div class="col-md-3">
                                <a class="btn btn-success" href="tambahkos-alamat.php">Kembali</a>
                            </div>
                            <div class="col">
                                <a class="btn btn-primary" href="tambahkos-fotokamar.php">Lanjutkan</a>
                            </div>
                        </div>
                    </div>
                </div>
