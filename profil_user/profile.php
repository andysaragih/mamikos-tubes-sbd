...
$id = $_SESSION['id_user'];
$tampil = "SELECT * FROM riwayat_kos WHERE id_user = '$id' ";
...
<head>
    ...
    <title>Profil | Mamikos - Cari, Bayar, & Sewa Kost Impianmu Secara Online</title>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-7 col-12">
                <div class="bg-c-card bg-c-card--md bg-c-card--lined bg-c-card--light">
                    <div class="user-kost-main__title bg-c-text--heading-5 bg-c-text mb-3">
                        Riwayat Kos
                    </div>
                            ...
                            <?php foreach ($sql as $data) { ?>
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text my-0"><small class="text-muted">Masuk : <?= $data['tanggal_masuk'] ?></small></p>
                                        <p class="card-text mt-0"><small class="text-muted">Selesai Sewa : <?= $data['tanggal_keluar'] ?></small></p>
                                        <a class="btn btn-outline-success" href="review.php?id_kos=<?= $data['id_kos']; ?>">Review</a>
