                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text my-0"><small class="text-muted">Masuk : 24 Mei</small></p>
                                    <p class="card-text mt-0"><small class="text-muted">Selesai Sewa : 24 Juni </small></p>
                                    <a class="btn btn-outline-secondary" href="../kos/detail-kos.php">Detail</a>
                                    <a class="btn btn-outline-success" href="review.php">Review</a>
                                </div>
                            </div>
                        </div>
                    </div>
