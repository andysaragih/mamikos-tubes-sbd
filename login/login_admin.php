...
<head>
    ...
    <title>Login Pemilik Mamikos - Cari, Bayar, & Sewa Kost Impianmu Secara Online</title>
        ...
        <div class="container d-flex  flex-column">
            ...
            <form method="post">
                ...
                <div class="phone-number1" role="textbox" aria-required="true" aria-invalid="false">
                    <input type="tel" name="username" maxlength="14" placeholder="Username" required=" required" class="phone-number2">
                </div>
                <br>
                ...
                <button class="divider-custom-daftar" name="submitAdmin" type=" submit">Login</button>
            </form><br>
