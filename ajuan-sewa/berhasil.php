                    ...
                    <div class="user-kost">
                        <div class="row">
                            <div class="col d-flex align-items-center justify-content-center mb-3">
                                ...
                                <p class="card-text"><b>Pengajuan Sewa Berhasil</b>
                                    <br>Anda telah berhasil melakukan pengajuan sewa
                                </p>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="d-grid gap-2">
                            <a class="btn btn-success my-3" href="../kos/detail-kos.php">Back to the Home</a>
                        </div>
                    </div>
                </div>
            </div>
